...
class Pair{
	...
	public Pair(double X, double Y) { //Pair is a set of x and y components -- for some field/variable
		x=X;
		y=Y; }
	public Pair times(double time) {
		Pair temp = new Pair(x,y); 
		//temp, not "this.x", bc don't want to alter the actual values
		temp.x *= time;
		temp.y *= time;
		return temp; }
	public void flipY() {
...
class Sphere extends Shape{
	...
	public Sphere(Pair location, Color col, int radius) {
		loc=location;   color = new Color(r,b,g); ;   rad=radius;
	}
	*/
