...
// =============================================================================
    ...
    public void evolve (){
        for(int r=0; r< this.getRows(); r++){
            for(int c=0; c < this.getColumns(); c++){ this.getCell(r, c).evolve();} }
	} // evolve ()
    // =========================================================================
	...
	public void advance(){
        for(int r=0; r< this.getRows(); r++){
            for(int c=0; c< this.getColumns(); c++){this.getCell(r, c).advance(); } }
	} // advance ()
    // =========================================================================
    ...
    public int getPopulation () {
        int popC = 0; //population counter
        //For each row and column...
        for(int r=0; r<this.getRows(); r++){ for(int c=0; c<this.getColumns(); c++){ 
            //if the cell is alive at the location, then increment pop counter
            if(this.getCell(r, c).isAlive()) popC++; } }
        return popC; } // getPopulation()
    // =========================================================================
